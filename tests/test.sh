...
## Deletion tests
is "$(${svaha} -r ${data}/tgraph.fa -v ${data}/tdel.vcf -m 128  | grep -v "^P\|^H" | sort | md5sum | cut -f 1 -d ' ')" "239b9ae8a090f7e79c8f9c65f88a9ceb" "Graphical deletions are properly produced"
is "$(${svaha} -r ${data}/tgraph.fa -v ${data}/tdel.vcf -f -m 128 | grep -v "^P\|^H" | sort | md5sum | cut -f 1 -d ' ')" "717cedc93001238cfbc64dd937ad74a7" "Flat deletions are properly produced"
